...
class Game extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('bg', 'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/1-299mem-31meg-1607544523.jpg?crop=1.00xw:0.755xh;0,0.213xh&resize=1200:*')

    this.load.image('onion', "assets/onion.png")

    this.load.image('hero-run-sheet', 'https://cdn.pixabay.com/photo/2020/05/01/15/45/mouse-5117776_1280.png')
  }
  ...
  spawnOnion() {
    ...
    this.physics.add.overlap(this.hero, onion, () => {
      ...
      this.text.destroy()
      this.add.text(50, 20, `YOU LOSE, try again, your score was ${this.score}`)
      setTimeout(() => this.scene.restart(), 2000)
    })

    this.score += 1
    setTimeout(() => {onion.destroy()}, 2000)
  }
